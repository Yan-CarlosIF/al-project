...
export default function Home() {
  return (
    <>
      <Head>
        <title>Álgebra Linear em 3D • React Three Fiber</title>
        <meta
          name="description"
          content="Explore como álgebra linear se aplica na modelagem 3D com React Three Fiber."
        />
      </Head>
      ...
      <main className="bg-white font-sans text-gray-900">
        ...
        <section className="mx-auto grid max-w-6xl items-center gap-10 bg-gray-50 px-6 py-16 md:grid-cols-2">
          ...
          <div>
            ...
            <p className="mb-4">
              Vetores em R³ são fundamentais para representar posições e
              direções em espaços tridimensionais. Cada vetor é definido por uma
              tripla ordenada [x, y, z], podendo representar deslocamentos,
              forças ou posições.
            </p>
            <p>
        ...
        <section className="mx-auto grid max-w-6xl items-center gap-10 px-6 py-16 md:grid-cols-2">
          <div>
            ...
            <p>
              Em 3D, as mudanças de base são realizadas por meio de
              multiplicações matriciais eficientes.
            </p>
          </div>
          <Image
            src="/change-base.jpg"
        ...
        <section className="mx-auto grid max-w-6xl items-center gap-10 bg-gray-50 px-6 py-16 md:grid-cols-2">
          ...
          <div>
            ...
            <p>
              Essas operações permitem animar, deformar e posicionar elementos
              de forma realista e eficiente.
            </p>
          </div>
        </section>
        ...
        <footer className="bg-gray-900 py-10 text-center text-white">
          <p>
            ...
            • Projeto baseado em React Three Fiber e conceitos de Álgebra
            Linear.
          </p>
        </footer>
      </main>
